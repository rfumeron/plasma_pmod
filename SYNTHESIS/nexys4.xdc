...
set_property PACKAGE_PIN C4 [get_ports i_uart]
set_property IOSTANDARD LVCMOS33 [get_ports i_uart]
##Bank = 35, Pin name = IO_L11N_T1_SRCC_35,					Sch name = UART_RXD_OUT
set_property PACKAGE_PIN D4 [get_ports o_uart]
set_property IOSTANDARD LVCMOS33 [get_ports o_uart]
